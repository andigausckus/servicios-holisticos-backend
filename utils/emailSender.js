...
<img src="https://i.postimg.cc/xTCF8sfm/IMG-20250607-170740-893.webp" alt="Logo de la plataforma" style="width: 50px; height: auto; margin: 10px auto; display: block;">
  ...
  <p>Hola ${nombreCliente},</p>    <p>¡Gracias por confiar en Servicios Holísticos 🌿!</p>    <p>Tu sesión fue confirmada exitosamente. A continuación te compartimos los detalles de la reserva:</p>    <p>  
...
</p>    <p>✨ El terapeuta ya fue notificado de tu sesión. Podés escribirle antes si tenés dudas o esperar al día del encuentro.</p>  <p>Una vez finalizada la sesión, podrás dejar una reseña sobre tu experiencia para ayudar a otros usuarios en su elección.</p>  <p>Si necesitás ayuda, podés responder directamente a este correo.</p>    <p>Con cariño 🌸<br>    <p><strong>El equipo de Servicios Holísticos</strong></p>  
`;  const cuerpoTerapeuta = `
<img src="https://i.postimg.cc/xTCF8sfm/IMG-20250607-170740-893.webp" alt="Logo de la plataforma" style="width: 50px; height: auto; margin: 10px auto; display: block;">

  <p>👋 Hola ${nombreTerapeuta}!</p>    <p>¡Tenés una nueva reserva confirmada! 🎉</p>    <p>🧘 Usuario: ${nombreCliente}</p>  
  <p>🛎️ Servicio: ${nombreServicio}</p>  
  <p>📅 Fecha: ${fechaFormateada}</p>  
  <p>🕒 Hora: ${hora} a ${horaFinal}</p>  
  <p>💵 Valor de la sesión: $${precio}</p>    <p>${nombreCliente} podrá escribirte antes de la sesión por email o WhatsApp si tiene alguna duda, o el mismo día del encuentro.</p>  <p>💸 El pago correspondiente a esta sesión será procesado y enviado a tu cuenta en un plazo máximo de 60 minutos.</p>  <p>✨ Te deseamos una excelente sesión ✨</p>  <p>Recordá que, una vez finalizada la sesión, el usuario podrá dejar una reseña sobre tu servicio.</p>  <p>Una buena experiencia, cordialidad y profesionalismo te ayudarán a construir una gran reputación dentro de la plataforma.</p>  <p>Con cariño 🌸<br>    <p><strong>El equipo de Servicios Holísticos</strong></p>  
`;  const cuerpoAdmin = `

  <p><strong>💡 Nueva reserva confirmada:</strong></p>    <p>👤 <strong>Cliente:</strong> ${nombreCliente}</p>  
  <p>🛎️ <strong>Servicio:</strong> ${nombreServicio}</p>  
  <p>📅 <strong>Fecha:</strong> ${fechaFormateada}</p>  
  <p>🕒 <strong>Hora:</strong> ${hora} a ${horaFinal}</p>  
  <p>💵 <strong>Precio pagado:</strong> $${precio}</p>    <br>  
  <p><strong>Datos del terapeuta:</strong></p>    <p>🧘 <strong>Terapeuta:</strong> ${nombreTerapeuta} (${emailTerapeuta})</p>  
  <p><strong>CBU/CVU:</strong> ${cbuTerapeuta}</p>  
  <p><strong>Banco:</strong> ${bancoTerapeuta}</p>    <p style="margin-top: 20px;">  
...
<p>Con cariño 🌸<br>  <p><strong>El equipo de Servicios Holísticos</strong></p>
